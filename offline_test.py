...
def test_policy(policy_file,
    ...
    checkpoint = torch.load(policy_file, map_location="cpu", weights_only=False)

    # use different actors
    state_dict = {
        k.replace("model.", ""): v
        for k, v in checkpoint["last_best_actor"].items()
...
def main():
    ...
    for idx in range(0, 1):
        ...
        policy_file = "/Users/zhangyizhong/Desktop/meta_rl-develop_9/ddpg/ddpg_adapted.pt"
