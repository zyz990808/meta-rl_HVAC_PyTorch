...
![Numeric_Results](./numeric_results.png)
...
This project shows that meta-reinforcement learning can learn a general HVAC control strategy and adapt it efficiently to new environments, achieving both comfort and energy efficiency.
